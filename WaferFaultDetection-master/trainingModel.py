...
class trainModel:
    ...
    def trainingModel(self):
        ...
        try:
            ...
            for i in list_of_clusters:#dataset for cluster no. 1,2,3,etc
                #first it will go in cluster no.1 then complete the following code,then cluster no.2 and so on

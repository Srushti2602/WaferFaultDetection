...
class Preprocessor:
    ...
    def get_columns_with_zero_std_deviation(self,data):#means no variance in dataset(all values are close to mean)
        #that is there is no relationship between the data so drop it
        """

...
class pred_validation:
    ...
    def prediction_validation(self):
        ...
        try:
            ...
            self.log_writer.log(self.file_object,'Start of Validation on files for prediction!!','aditya')#to call function of App_logger we have to
            #call object of that class.function
            #extracting values from prediction schema
            LengthOfDateStampInFile,LengthOfTimeStampInFile,column_names,noofcolumns = self.raw_data.valuesFromSchema()
            #getting the regex defined to validate filename
            regex = self.raw_data.manualRegexCreation()#used for validation of the name of filename
            #validating filename of prediction files
            self.raw_data.validationFileNameRaw(regex,LengthOfDateStampInFile,LengthOfTimeStampInFile)
            #validating column length in the file
            self.raw_data.validateColumnLength(noofcolumns)#check the length of co;lumns
